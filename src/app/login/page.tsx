    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center p-6 overflow-hidden font-['Outfit']">
            ...
            <div className="absolute inset-0 bg-slate-950">
                <div className="absolute top-0 -left-4 w-72 h-72 bg-sgd-500 rounded-full mix-blend-screen filter blur-[80px] opacity-20 animate-blob"></div>
                <div className="absolute bottom-0 -right-4 w-80 h-80 bg-amber-500 rounded-full mix-blend-screen filter blur-[100px] opacity-10 animate-blob [animation-delay:2000ms]"></div>
            </div>

            <div className="relative z-10 w-full max-w-md">
                <div className="bg-white/5 backdrop-blur-3xl rounded-[2.5rem] p-1 border border-white/10 shadow-2xl">
                    <div className="bg-white rounded-[2.3rem] p-10 shadow-inner">

                        {/* Logo Section */}
                        <div className="text-center mb-6">
                            <div className="relative inline-block mb-4">
                                <div className="absolute inset-0 bg-sgd-500 rounded-3xl blur-xl opacity-30 animate-pulse"></div>
                            ...
                            <div className="inline-block px-3 py-1 bg-amber-50 rounded-full mt-1.5 border border-amber-100">
                                <p className="text-[9px] font-black text-[#AA8522] uppercase tracking-widest">Peminjaman Alat Inventaris SGD</p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-4" noValidate>
                            <div className="relative group">
                                <div className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center group-focus-within:bg-[#25D366] group-focus-within:text-white transition-all text-[#25D366] z-10 border border-gray-100 group-focus-within:border-[#25D366] shadow-sm">
                                ...
                                <input
                                    ...
                                    className="w-full !pl-20 pr-5 py-5 !bg-gray-50 !border-gray-200 !text-slate-900 rounded-2xl focus:!border-[#25D366] focus:!bg-white outline-none transition-all text-sm font-bold placeholder:text-gray-400 shadow-sm"
                                    value={whatsapp}
                            ...
                            <button type="submit" disabled={loading} className="relative w-full group pt-2">
                                ...
                                <div className="relative bg-[#0a0a0a] border border-white/5 text-white font-black py-4 rounded-2xl shadow-2xl flex items-center justify-center gap-3 active:scale-95 transition-transform overflow-hidden">
                                    ...
                                    <div className="w-6 h-6 rounded-lg bg-sgd-500 flex items-center justify-center text-black">
